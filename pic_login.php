...
echo '<body class="bg-gradient-light">';
        ...
        "<form class='user' action='' method='POST'>" .
            //"<p>" .
                "<div class='form-group'>" .
                    "<input class='form-control form-control-user' type='text' name='pic_username' autocomplete='off' placeholder='Username or ID Number'/>" .
                "</div>" .
                "<div class='form-group'>" .
                    "<input class='form-control form-control-user' type='password' name='pic_password' placeholder='Password'/>" .
                "</div>" .
            //"</p>" .
            "<p><input class='btn btn-secondary btn-user btn-block text-black' type='submit' name='pic_login_button' value='Login'/></p>" .
            //"<p><input class='btn btn-primary btn-user btn-block' type='reset' value='Clear' /></p>" .
            "<hr />" .
            "<div class='text-center'><p style='text-align: center;'><a href='pic_forgot_password.php'>Forgot Password?</a></p></div>" .
        "</form>";
        echo login_body("PIC Login", $login_body);
    echo '</div>';
    ...
    if(isset($_POST['pic_login_button']))
    {
        ...
        {
            $query = sprintf("SELECT * FROM pic WHERE picUsername = '%s' OR picIDNo='%s'", 
